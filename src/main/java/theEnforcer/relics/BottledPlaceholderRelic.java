...
import theEnforcer.patches.relics.BottledPlaceholderField;
import theEnforcer.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theEnforcer.DefaultMod.makeRelicOutlinePath;
import static theEnforcer.DefaultMod.makeRelicPath;
