...
public class ToxicVent extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(ToxicVent.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if(!p.hasPower("StimmedPower")) {
            ...
            AbstractDungeon.actionManager.addToBottom(
                    new DamageAllEnemiesAction(p, damage, damageTypeForTurn, AbstractGameAction.AttackEffect.POISON)
            );
            AbstractDungeon.actionManager.addToBottom(
