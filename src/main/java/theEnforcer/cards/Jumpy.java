...
import theEnforcer.powers.JumpyPower;

import static theEnforcer.DefaultMod.makeCardPath;

public class Jumpy extends AbstractDynamicCard {
    // TEXT DECLARATION 

    public static final String ID = DefaultMod.makeID(Jumpy.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
                new JumpyPower(p, p, magicNumber), magicNumber));
        /*
