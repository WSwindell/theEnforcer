...
import theEnforcer.powers.LingeringToxinPower;

import static theEnforcer.DefaultMod.makeCardPath;

public class LingeringToxin extends AbstractDynamicCard {
    // TEXT DECLARATION 

    public static final String ID = DefaultMod.makeID(LingeringToxin.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
                new LingeringToxinPower(p, p, magicNumber, upgraded), magicNumber));
