...
import theEnforcer.powers.MercurialResolvePower;

import static theEnforcer.DefaultMod.makeCardPath;

public class MercurialResolve extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(MercurialResolve.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
                new MercurialResolvePower(p, p, magicNumber), magicNumber));
        /*
