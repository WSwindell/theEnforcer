...
public class Shear extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(Shear.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(m.hasPower("Thorns")) {
            AbstractDungeon.actionManager.addToBottom(
            new RemoveSpecificPowerAction(m, p, "Thorns"));
        }
        if(m.hasPower("Sharp Hide")) {
            AbstractDungeon.actionManager.addToBottom(
                    new RemoveSpecificPowerAction(m, p, "Sharp Hide"));
        }
    }
